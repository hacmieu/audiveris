...
|---|---|---|
| 2026-07-26 01:16 | [**✅ Triển khai alphaTab player**](20260726_0116-trien-khai-alphatab-player.md) | **MỚI NHẤT.** `web/` Vite+React; play Yêu Xa đã xác minh trên browser (cursor + transport). |
...
3. FE: `cd web && npm run dev` → http://localhost:5173/
